...
Usage:
    ...
    conda run -n deep_field python scripts/fire_model/01_build_panel.py --force
"""
...
# Sampling
NEG_GRID_SPACING = 5  # every 5th pixel
MIN_ACRES = 300
SEED = 42

# Time periods
TRAIN_END_YM = "2016-12"
CALIB_END_YM = "2019-09"
